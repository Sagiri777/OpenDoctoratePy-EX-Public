...
app.add_url_rule("/activity/act1vhalfidle/upgradeChar", methods=["POST"], view_func=activity.vhalfidle.upgradeChar)
app.add_url_rule("/activity/act1vhalfidle/upgradeSkill", methods=["POST"], view_func=activity.vhalfidle.upgradeSkill)
app.add_url_rule("/activity/act1vhalfidle/evolveChar", methods=["POST"], view_func=activity.vhalfidle.evolveChar)
